...
이 Semi-Project는 Webkit640 7기 (2025년 대학·기업 협력형 SW아카데미 사업 풀스택 개발자 양성과정 7기)에 이론교육 과제로 제출한 
React와 Node.js를 활용하여 개발한 Web 입니다. 

Google Gemini API를 활용한 AI 번역 기능과 함께, 사용자들이 소통할 수 있는 기본적인 커뮤니티 기능을 CRUD의 개념을 익히기 위해 추가하였습니다.
